...
from transformers import AutoTokenizer, AutoModelForCausalLM, BertGenerationEncoder, BertGenerationDecoder, EncoderDecoderModel, BertTokenizer
...
def tokenize_data(example):
    inputs = tokenizer(example["input_text"], max_length=512, padding="max_length", truncation=True, return_tensors="pt")
    outputs = tokenizer(example["output_text"], max_length=512, padding="max_length", truncation=True, return_tensors="pt")
...
input_text = "I randomly get nauseatic and I have been constantly vomiting for the last few days. I also have a mild fever."
# Tokenize the input
...
#     outputs = model.generate(inputs["input_ids"], attention_mask=inputs["attention_mask"], max_length=200, num_beams=5)
