...
def preprocess_data(example):
    input_text = (f"<|begin_of_text|>"
                  ...
                  f"system"
                  f"<|end_header_id|>"
                  f"Your are a proficient doctor specializing in Gynaecology. You always try your best to help your patient."
                  f"<|eot_id|>"
                  f"<|start_header_id|>"
                  f"user"
                  f"<|end_header_id|>"
...
#     elif "embed_tokens" in name or "norm" in name:
#         # Optionally freeze embedding or normalization layers
#         param.requires_grad = False